...
//设置 SPTabBarItem 的 View 的 frame，
//或者返回一个 SPSideTabItemButton
...
//根据 UITabBarItem 设置对应的 SPSideTabItemButton 效果
...
////根据 UITabBarItem 返回对应的 SPSideTabItemButton 的 Frame
